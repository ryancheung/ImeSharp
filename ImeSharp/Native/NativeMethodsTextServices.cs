...
namespace ImeSharp.Native
{
    public partial class NativeMethods
    {
        ...
        */
        ...
        {
            public Guid clsid;        // CLSID of tip
            public short langid;      // language id
            public Guid catid;         // category of tip
            [MarshalAs(UnmanagedType.Bool)]
            public bool fActive;       // activated profile
        ...
        public interface ITfCandidateListUIElement
        {
        ...
        public interface ITfEditRecord
        {
            ...
            //
            void GetTextAndPropertyUpdates(int flags,
