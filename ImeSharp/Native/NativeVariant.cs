...
//
// This class wraps a VARIANT type for interop with the unmanaged TSF APIs.  Only
    ...
    public partial class NativeMethods
    {
        ...
        public struct VARIANT
        {
            ...
            )
            {
                if (cbFrom > cbTo)
                {
                    throw new InvalidOperationException("TSF_InsufficientBufferSize");
                }
            ...
            internal void Init(object value)
            {
                ...
                else if (value is Array)
                {
                    ...
                    {
                        throw new System.InvalidOperationException("TSF_PropertyNotSupported");
                    }
                }
                else
                {
            ...
            internal void Clear()
            {
                ...
                if ((vt & VarEnum.VT_VECTOR) != 0 || vt == VarEnum.VT_BLOB)
                {
                    if (ca.pElems != IntPtr.Zero)
                    {
                        ...
                        if (vt == VarEnum.VT_LPWSTR || vt == VarEnum.VT_LPSTR)
                        {
